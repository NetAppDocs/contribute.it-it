...
* BEST PRACTICE utilizzare la BEST PRACTICE per evidenziare i modi ottimali per completare le attività o utilizzare un prodotto. Non si tratta di semplici suggerimenti, ma di strategie che sono state convalidate da esperti o standard di settore.
+
** *Che cosa fa una PRATICA MIGLIORE?* Si tratta di una strategia attuabile e specifica per le attività che offre vantaggi chiari ed è supportata da fonti affidabili.
** *Quando posso usarle?* Puoi utilizzare LE BEST PRACTICE per tutti i tipi di contenuti e per tutti gli utenti. Come LE PUNTE, usali con parsimonia per mantenere il loro significato.
** *Come li formatta?* Presentare le BEST PRACTICE in un formato coerente e intuitivo. Potrebbe trattarsi di un elenco puntato, di un elenco numerato o di un paragrafo, a seconda del contesto.
